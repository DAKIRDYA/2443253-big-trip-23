...
Сервер расположен по адресу https://23.objects.htmlacademy.pro/big-trip.

Спецификация по взаимодействию с сервером в формате OpenAPI — https://23.objects.htmlacademy.pro/spec/big-trip.
